...
import com.example.yaroslav.socialapp.model.twitter_requester.TwitterRequester;
import com.example.yaroslav.socialapp.model.twitter_requester.TwitterRequesterImpl;
...
public class TwitterPresenter extends Callback<TwitterSession> implements Presenter {
    ...
    public TwitterPresenter(Activity activity){
        ...
        requester = new TwitterRequesterImpl();
    }

    Callback<User> twitterUserCallback = new Callback<User>() {
        @Override
        ...
        public void failure(TwitterException exception) {
            Log.d(LOG_TAG, "TWITTER GET USER ERROR");
        }
    };
    ...
    public void success(Result<TwitterSession> result) {
        ...
        requester.request(session, twitterUserCallback);
